...
<%@ page import="com.liferay.commerce.product.service.CPDefinitionLocalService" %>
...
<%@ page import="com.liferay.commerce.demo.tabbed.renderer.display.context.TabbedRendererDisplayContext" %>
