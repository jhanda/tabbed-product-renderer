package com.liferay.commerce.demo.tabbed.renderer.display.context;
 ...
 * @author Jeff Handa
 */
public class TabbedRendererDisplayContext {

    public TabbedRendererDisplayContext(
    ...
    private static final Log _log = LogFactoryUtil.getLog(
            TabbedRendererDisplayContext.class);
